...
//public class SignupFordrive extends ExtentReportsDemo {
	public class JustPassword extends BaseClass {
	...
	public void SignupForddrive_withoutCC() throws MalformedURLException {
		// run launch chrome
		try {
	       ...
	       //import page class and initialse obj of this all page class
			...
			FileInputStream fs = new FileInputStream("/Users/sgrover7/eclipse-workspace/ios/src/test/resources/InputFile/JustPassword.xlsx");
			...
			for (int j = 1; j <= rowNum; j++) {
				...
				for (int i = 1; i <= noOfsignups; i++) {
					...
					//click on down arrow of password page
					creditcardpg.create_password1();
					
					//Check if status is pending pickup
					dashbpg.Verify_CCFields();
