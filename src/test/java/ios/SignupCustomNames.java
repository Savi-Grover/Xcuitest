...
//public class SignupFordrive extends ExtentReportsDemo {
	public class SignupCustomNames extends BaseClass {
	...
	public void SignupForddrive() throws MalformedURLException {
		...
		try {
	       ...
	       //import page class and initialse obj of this all page class
			...
			FileInputStream fs = new FileInputStream("/Users/sgrover7/eclipse-workspace/ios/src/test/resources/InputFile/SignupCustomNames.xlsx");
			...
			for (int j = 1; j <= rowNum; j++) {
				...
				for (int i = 1; i <= noOfsignups; i++) {
					...
					//Partial page enter data - custom
					PartialSignupPg.fill_signup_custom("Wylma","Hurd");
					...
					// address page
					applicnpg.fill_application_custom("1905 QUAIL RIDGE	RD","RALEIGH","NC","48317");
